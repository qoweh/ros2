...
keep1_v39_17d_mid_curriculum_fixed
  <- keep1_v36_17d_balanced_xyz012
      <- keep1_v34_17d_long_xyz012
          <- keep1_v33 / keep1_v32_17d 계열
              <- keep1_v32_17d_init
                  <- keep1_v30 / v26 계열
                      <- v25 이전 contact-frame self-rally 실험
                          <- heuristic diagnostic / bootstrap 실험
                              <- pingpong_rl 초기 EE-delta PPO + tracking assist
```
