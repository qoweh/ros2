...
작성일: 2026-06-06  
대상 저장소: `/Users/pilt/project-collection/ros2/graduation-prj`
...
| `summerize-init/claude-proposal.md` | SO-101, Gazebo, ros_gz, MuJoCo 후보 비교 |
| `summerize-init/claude-proposal2.md` | 로봇팔 강화학습 시뮬레이션 개발 방향 제안 |
| `summerize-init/gemini-proposa.md` | SO-101 Gazebo 컨트롤 개발 후보군 |
| `summerize-init/gemini-proposal2.md` | 로봇팔 RL 프로젝트 제안서 v2 |
